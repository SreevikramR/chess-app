...
const PopUp = () => {
  const {popUpState, setPopUpState, openingName, popUpType} = useChessboard()
  ...
  return (
    <>
        <div className="modal"  id="modal">
          ...
          {content}
            <Link to={popUpLink} onClick={() => setPopUpState(false)}>
