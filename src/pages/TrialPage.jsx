    ...
    return(
        <>
            ...
            <div className='content'>
                <div className="row">
                    <div className="hc1">
                        <TrainBoardWhite openingName={openeingName} openingLine={openingLine} moveHistory={moveHistory} updateMoveHistory={updateMoveHistory} setMoveResult={setMoveResultFunc}/>
                    </div>
                    <div className="hc2">
                        <h1>{openeingName}</h1>
                        
                        <MoveTable moveSequence={moveSequence} moves={moveHistory} openingLine={openingLine} moveResult={moveResult}/>
